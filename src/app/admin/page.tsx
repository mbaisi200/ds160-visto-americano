        ...
        <DialogContent className="max-w-4xl max-h-[85vh] sm:max-h-[80vh] overflow-y-auto mx-2 sm:mx-0">
          ...
          {selectedForm && (() => {
            ...
            const sections = {
              ...
              trabalho: ['jobTitle', 'companyName', 'companyAddress', 'companyNumber', 'companyCity', 'companyState', 'companyZip', 'companyPhone', 'companyStartDate', 'jobDescription', 'companySalary', 'extraIncomeAmount', 'extraIncomeDescription'],
              ocupacaoAnterior: ['hasPrevJob', 'prevJobsList'],
              universitario: ['hasUniversity', 'universityName', 'universityAddress', 'universityNumber', 'universityCity', 'universityState', 'universityZip', 'universityCourse', 'universityStartDate', 'universityEndDate', 'schoolsList'],
            ...
            const fieldLabels: Record<string, string> = {
              ...
              jobTitle: 'Ocupação', companyName: 'Empresa', companyAddress: 'Endereço da empresa', companyNumber: 'Número', companyCity: 'Cidade da empresa', companyState: 'Estado da empresa',
              ...
              hasUniversity: 'Frequentou universidade', universityName: 'Nome da instituição', universityAddress: 'Endereço', universityNumber: 'Número', universityCity: 'Cidade',
